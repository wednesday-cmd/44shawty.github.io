(function(e){"object"==typeof exports&&"object"==typeof module?e(require("../../lib/codemirror")):"function"==typeof define&&define.amd?define(["../../lib/codemirror"],e):e(CodeMirror)})(function(e){e.defineMode("sql",function(l,f){function k(c,g){var b=c.next();if(m[b]){var e=m[b](c,g);if(!1!==e)return e}if(h.hexNumber&&("0"==b&&c.match(/^[xX][0-9a-fA-F]+/)||("x"==b||"X"==b)&&c.match(/^'[0-9a-fA-F]+'/))||h.binaryNumber&&(("b"==b||"B"==b)&&c.match(/^'[01]+'/)||"0"==b&&c.match(/^b[01]+/)))return"number";
if(47<b.charCodeAt(0)&&58>b.charCodeAt(0))return c.match(/^[0-9]*(\.[0-9]+)?([eE][-+]?[0-9]+)?/),h.decimallessFloat&&c.match(/^\.(?!\.)/),"number";if("?"==b&&(c.eatSpace()||c.eol()||c.eat(";")))return"variable-3";if("'"==b||'"'==b&&h.doubleQuote)return g.tokenize=a(b),g.tokenize(c,g);if(!(h.nCharCast&&("n"==b||"N"==b)||h.charsetCast&&"_"==b&&c.match(/[a-z][a-z0-9]*/i))||"'"!=c.peek()&&'"'!=c.peek()){if(/^[\(\),\;\[\]]/.test(b))return null;if(h.commentSlashSlash&&"/"==b&&c.eat("/")||h.commentHash&&
"#"==b||"-"==b&&c.eat("-")&&(!h.commentSpaceRequired||c.eat(" ")))return c.skipToEnd(),"comment";if("/"==b&&c.eat("*"))return g.tokenize=d(1),g.tokenize(c,g);if("."==b){if(h.zerolessFloat&&c.match(/^(?:\d+(?:e[+-]?\d+)?)/i))return"number";if(c.match(/^\.+/))return null;if(h.ODBCdotTable&&c.match(/^[\w\d_]+/))return"variable-2"}else{if(n.test(b))return c.eatWhile(n),null;if("{"==b&&(c.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/)||c.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/)))return"number";c.eatWhile(/^[_\w\d]/);
b=c.current().toLowerCase();return q.hasOwnProperty(b)&&(c.match(/^( )+'[^']*'/)||c.match(/^( )+"[^"]*"/))?"number":r.hasOwnProperty(b)?"atom":t.hasOwnProperty(b)?"builtin":u.hasOwnProperty(b)?"keyword":v.hasOwnProperty(b)?"string-2":null}}else return"keyword"}function a(a){return function(c,b){for(var d=!1,g;null!=(g=c.next());){if(g==a&&!d){b.tokenize=k;break}d=!d&&"\\"==g}return"string"}}function d(a){return function(c,b){var g=c.match(/^.*?(\/\*|\*\/)/);g?b.tokenize="/*"==g[1]?d(a+1):1<a?d(a-
1):k:c.skipToEnd();return"comment"}}function p(a,d,b){d.context={prev:d.context,indent:a.indentation(),col:a.column(),type:b}}var v=f.client||{},r=f.atoms||{"false":!0,"true":!0,"null":!0},t=f.builtin||{},u=f.keywords||{},n=f.operatorChars||/^[*+\-%<>!=&|~^]/,h=f.support||{},m=f.hooks||{},q=f.dateSQL||{date:!0,time:!0,timestamp:!0};return{startState:function(){return{tokenize:k,context:null}},token:function(a,d){a.sol()&&d.context&&null==d.context.align&&(d.context.align=!1);if(d.tokenize==k&&a.eatSpace())return null;
var b=d.tokenize(a,d);if("comment"==b)return b;d.context&&null==d.context.align&&(d.context.align=!0);var c=a.current();"("==c?p(a,d,")"):"["==c?p(a,d,"]"):d.context&&d.context.type==c&&(d.indent=d.context.indent,d.context=d.context.prev);return b},indent:function(a,d){var b=a.context;if(!b)return e.Pass;var c=d.charAt(0)==b.type;return b.align?b.col+(c?0:1):b.indent+(c?0:l.indentUnit)},blockCommentStart:"/*",blockCommentEnd:"*/",lineComment:h.commentSlashSlash?"//":h.commentHash?"#":"--"}});(function(){function l(a){for(var d;null!=
(d=a.next());)if("`"==d&&!a.eat("`"))return"variable-2";a.backUp(a.current().length-1);return a.eatWhile(/\w/)?"variable-2":null}function f(a){a.eat("@")&&(a.match(/^session\./),a.match(/^local\./),a.match(/^global\./));return a.eat("'")?(a.match(/^.*'/),"variable-2"):a.eat('"')?(a.match(/^.*"/),"variable-2"):a.eat("`")?(a.match(/^.*`/),"variable-2"):a.match(/^[0-9a-zA-Z$\.\_]+/)?"variable-2":null}function k(a){return a.eat("N")?"atom":a.match(/^[a-zA-Z.#!?]/)?"variable-2":null}function a(a){var d=
{};a=a.split(" ");for(var e=0;e<a.length;++e)d[a[e]]=!0;return d}e.defineMIME("text/x-sql",{name:"sql",keywords:a("alter and as asc between by count create delete desc distinct drop from group having in insert into is join like not on or order select set table union update values where limit begin"),builtin:a("bool boolean bit blob enum long longblob longtext medium mediumblob mediumint mediumtext time timestamp tinyblob tinyint tinytext text bigint int int1 int2 int3 int4 int8 integer float float4 float8 double char varbinary varchar varcharacter precision real date datetime year unsigned signed decimal numeric"),
