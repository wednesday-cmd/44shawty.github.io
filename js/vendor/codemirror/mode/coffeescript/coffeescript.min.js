(function(f){"object"==typeof exports&&"object"==typeof module?f(require("../../lib/codemirror")):"function"==typeof define&&define.amd?define(["../../lib/codemirror"],f):f(CodeMirror)})(function(f){f.defineMode("coffeescript",function(f,t){function k(a){return new RegExp("^(("+a.join(")|(")+"))\\b")}function h(a,b){if(a.sol()){null===b.scope.align&&(b.scope.align=!1);var c=b.scope.offset;if(a.eatSpace()){var d=a.indentation();return d>c&&"coffee"==b.scope.type?"indent":d<c?"dedent":null}0<c&&m(a,
...
b&&d.eol())return c}else{if(d.match(a))return e.tokenize=h,c;d.eat(/['"\/]/)}b&&(t.singleLineStringErrors?c="error":e.tokenize=h);return c}}function u(a,b){for(;!a.eol();){a.eatWhile(/[^#]/);if(a.match("###")){b.tokenize=h;break}a.eatWhile("#")}return"comment"}function n(a,b,c){c=c||"coffee";for(var d=0,e=!1,r=null,g=b.scope;g;g=g.prev)if("coffee"===g.type||"}"==g.type){d=g.offset+f.indentUnit;break}"coffee"!==c?(e=null,r=a.column()+a.current().length):b.scope.align&&(b.scope.align=!1);b.scope={offset:d,
type:c,prev:b.scope,align:e,alignOffset:r}}function m(a,b){if(b.scope.prev){if("coffee"===b.scope.type){for(var c=a.indentation(),d=!1,e=b.scope;e;e=e.prev)if(c===e.offset){d=!0;break}if(!d)return!0;for(;b.scope.prev&&b.scope.offset!==c;)b.scope=b.scope.prev}else b.scope=b.scope.prev;return!1}}var x=/^(?:->|=>|\+[+=]?|-[\-=]?|\*[\*=]?|\/[\/=]?|[=!]=|<[><]?=?|>>?=?|%=?|&=?|\|=?|\^=?|\~|!|\?|(or|and|\|\||&&|\?)=)/,z=/^(?:[()\[\]{},:`=;]|\.\.?\.?)/,q=/^[_A-Za-z$][_A-Za-z$0-9]*/,B=/^@[_A-Za-z$][_A-Za-z$0-9]*/,
y=k("and or not is isnt in instanceof typeof".split(" ")),l="for while loop if unless else switch try catch finally class".split(" "),C=k(l.concat("break by continue debugger delete do in of new return then this @ throw when until extends".split(" "))),l=k(l),v=/^('{3}|\"{3}|['\"])/,w=/^(\/{3}|\/)/,A=k("Infinity NaN undefined null true false on off yes no".split(" "));return{startState:function(a){return{tokenize:h,scope:{offset:a||0,type:"coffee",prev:null,align:!1},prop:!1,dedent:0}},token:function(a,
b){var c=null===b.scope.align&&b.scope;c&&a.sol()&&(c.align=!1);var d=b.tokenize(a,b);var e=a.current();"return"===e&&(b.dedent=!0);(("->"===e||"=>"===e)&&a.eol()||"indent"===d)&&n(a,b);var f="[({".indexOf(e);-1!==f&&n(a,b,"])}".slice(f,f+1));l.exec(e)&&n(a,b);"then"==e&&m(a,b);if("dedent"===d&&m(a,b))d="error";else{f="])}".indexOf(e);if(-1!==f){for(;"coffee"==b.scope.type&&b.scope.prev;)b.scope=b.scope.prev;b.scope.type==e&&(b.scope=b.scope.prev)}b.dedent&&a.eol()&&("coffee"==b.scope.type&&b.scope.prev&&
