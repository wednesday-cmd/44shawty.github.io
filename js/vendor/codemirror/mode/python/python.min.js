...
/^(\+=|\-=|\*=|%=|\/=|&=|\|=|\^=)/,C=c.tripleDelimiters||/^(\/\/=|>>=|<<=|\*\*=)/,p=c.hangingIndent||q.indentUnit,h=r,k=t;void 0!=c.extra_keywords&&(h=h.concat(c.extra_keywords));void 0!=c.extra_builtins&&(k=k.concat(c.extra_builtins));var z=!(c.version&&3>Number(c.version));if(z){var y=c.singleOperators||/^[\+\-\*\/%&|\^~<>!@]/;var m=c.identifiers||/^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/;h=h.concat("nonlocal False True None async await".split(" "));k=k.concat(["ascii","bytes","exec",
"print"]);var x=/^(([rbuf]|(br))?('{3}|"{3}|['"]))/i}else y=c.singleOperators||/^[\+\-\*\/%&|\^~<>!]/,m=c.identifiers||/^[_A-Za-z][_A-Za-z0-9]*/,h=h.concat(["exec","print"]),k=k.concat("apply basestring buffer cmp coerce execfile file intern long raw_input reduce reload unichr unicode xrange False True None".split(" ")),x=/^(([rubf]|(ur)|(br))?('{3}|"{3}|['"]))/i;var G=n(h),H=n(k);return{startState:function(a){return{tokenize:l,scopes:[{offset:a||0,type:"py",align:null}],indent:a||0,lastToken:null,
lambda:!1,dedent:0}},token:function(a,b){var d=b.errorToken;d&&(b.errorToken=!1);a:{a.sol()&&(b.beginningOfLine=!0);var e=b.tokenize(a,b);var c=a.current();if(b.beginningOfLine&&"@"==c)e=a.match(m,!1)?"meta":z?"operator":"error";else{/\S/.test(c)&&(b.beginningOfLine=!1);"variable"!=e&&"builtin"!=e||"meta"!=b.lastToken||(e="meta");if("pass"==c||"return"==c)b.dedent+=1;"lambda"==c&&(b.lambda=!0);":"!=c||b.lambda||"py"!=f(b).type||u(b);var g=1==c.length?"[({".indexOf(c):-1;if(-1!=g){var g="])}".slice(g,
g+1),h=a.match(/^([\s\[\{\(]|#.*)*$/,!1)?null:a.column()+1;b.scopes.push({offset:b.indent+p,type:g,align:h})}g="])}".indexOf(c);if(-1!=g)if(f(b).type==c)b.indent=b.scopes.pop().offset-p;else{e="error";break a}0<b.dedent&&a.eol()&&"py"==f(b).type&&(1<b.scopes.length&&b.scopes.pop(),--b.dedent)}}e&&"comment"!=e&&(b.lastToken="keyword"==e||"punctuation"==e?a.current():e);"punctuation"==e&&(e=null);a.eol()&&b.lambda&&(b.lambda=!1);return d?e+" error":e},indent:function(a,b){if(a.tokenize!=l)return a.tokenize.isString?
g.Pass:0;var d=f(a),c=d.type==b.charAt(0);return null!=d.align?d.align-(c?1:0):d.offset-(c?p:0)},electricInput:/^\s*[\}\]\)]$/,closeBrackets:{triples:"'\""},lineComment:"#",fold:"indent"}});g.defineMIME("text/x-python","python");g.defineMIME("text/x-cython",{name:"python",extra_keywords:"by cdef cimport cpdef ctypedef enum except extern gil include nogil property public readonly struct union DEF IF ELIF ELSE".split(" ")})});