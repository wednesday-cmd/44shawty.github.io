...
this.$editorTarget.length?(this.href=this.options.href||this.$target.attr("href"))||console.error("No edit URL specified."):console.error("No quick edit target found")):console.error("No quick edit editorTarget specified")},click:function(a){if(this.$editorTarget&&this.href&&(a.preventDefault(),!this.loading)){this.loading=!0;a={};this.options.noInlineMod&&(a._xfNoInlineMod=!0);var b=this;XF.ajax("GET",this.href,a,c.proxy(this,"handleAjax"),{skipDefaultSuccess:!0}).always(function(){setTimeout(function(){b.loading=
!1},300)})}},handleAjax:function(a){var b=this.$editorTarget,d=this;XF.setupHtmlInsert(a.html,function(a,g){a.hide().insertAfter(b);XF.activate(a);d.$editForm=a;a.on("ajax-submit:response",c.proxy(d,"editSubmit"));a.find(".js-cancelButton").on("click",c.proxy(d,"cancelClick"));b.xfFadeUp(null,function(){b.parent().addClass("is-editing");a.xfFadeDown(XF.config.speed.normal,function(){a.trigger("quick-edit:shown");var b=a.find(d.options.editContainer);b.length&&b.get(0).scrollIntoView(!0)})});a.trigger("quick-edit:show")})},
